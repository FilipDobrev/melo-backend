...
/// densityGPerMl is set for true liquids and semi-liquids so volume units
/// (mL, L, cup, tbsp, tsp) convert via density; gramsPerCup is set for
/// solids, using USDA SR Legacy-style measured household weights (a cup of
/// a solid is a measured weight, not a density times 240 mL - see
/// src/services/nutrition.ts). gramsPerPiece is set for countable items so
/// the PIECE unit works. All are omitted (undefined -> null) when the
/// product cannot be measured that way, so it correctly refuses that unit.
...
// gramsPerCup figures below are measured household weights, not derived from
// density, per USDA SR Legacy's food_portion.csv (gram_weight per "1 cup"
// portion for the matching SR food, rounded to whole grams).
const products: ProductSeed[] = [
  ...
  { name: 'White rice, cooked', caloriesPer100g: 130, proteinPer100g: 2.7, carbsPer100g: 28.2, fatPer100g: 0.3, sugarPer100g: 0.1, gramsPerCup: 158 },
  { name: 'Rolled oats', caloriesPer100g: 389, proteinPer100g: 16.9, carbsPer100g: 66.3, fatPer100g: 6.9, sugarPer100g: 0.99, gramsPerCup: 90 },
  ...
  { name: 'Broccoli', caloriesPer100g: 34, proteinPer100g: 2.8, carbsPer100g: 6.6, fatPer100g: 0.4, sugarPer100g: 1.7, gramsPerCup: 91 },
  ...
  { name: 'All-purpose flour', caloriesPer100g: 364, proteinPer100g: 10.3, carbsPer100g: 76.3, fatPer100g: 1, sugarPer100g: 0.3, gramsPerCup: 125 },
  { name: 'Granulated sugar', caloriesPer100g: 387, proteinPer100g: 0, carbsPer100g: 100, fatPer100g: 0, sugarPer100g: 100, gramsPerCup: 200 },
  ...
  { name: 'Black beans, cooked', caloriesPer100g: 132, proteinPer100g: 8.9, carbsPer100g: 23.7, fatPer100g: 0.5, sugarPer100g: 0.3, gramsPerCup: 172 },
  ...
  { name: 'Almonds', caloriesPer100g: 579, proteinPer100g: 21.2, carbsPer100g: 21.6, fatPer100g: 49.9, sugarPer100g: 4.2, gramsPerCup: 143 },
  ...
  for (const product of products) {
    await prisma.product.upsert({
      ...
      update: {
        ...
        gramsPerCup: product.gramsPerCup ?? null,
      },
      create: {
        name: product.name,
        source: SEED_SOURCE,
